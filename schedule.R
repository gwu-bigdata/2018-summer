...
l01 <- tibble(
  title_topic = "Welcome to Big Data: Course Overview, What is Big Data, Distributed Computing, Cloud Computing, High Performance Computing",
...
l02 <- tibble(
  title_topic = "The Infrastructure of the Cloud: Overview of major Cloud Computing providers (AWS and Azure), IAAS, PAAS and SAAS, Other Cloud providers",
  lab = "Start and connect to your first virtual machine on the cloud",
  reading = "",
  assignment = "",
  quiz = ""
)
...
l03 <- tibble(
  title_topic = "Introduction to Hadoop & MapReduce: Hadoop, Distributed filesystems, MapReduce programming model",
  lab = "Start and connect to a Hadoop cluster, run built-in Hadoop examples, examine the different user interfaces",
